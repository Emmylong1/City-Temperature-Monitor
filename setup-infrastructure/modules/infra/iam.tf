...
# Permissions for Secrets Manager to retrieve the password
resource "aws_iam_policy" "secretsmanager_policy" {
  name        = "${local.cluster_name}-secretsmanager-policy"
    ...
    Statement = [
      {
        ...
        Resource = "arn:aws:secretsmanager:REGION:ACCOUNT_ID:secret:mydb-password-*"
      }
    ]
  })
}
